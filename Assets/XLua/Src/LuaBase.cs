...
namespace XLua
{
    public abstract class LuaBase : IDisposable
    {
        ...
        protected readonly int luaReference;//registry_t[luaRefrence]中保存了对应的lua变量{C#中的一个LuaBase会对应一个在Lua中的变量}
        //猜测,应为将其放到了registry_t中, 所以不会被"lua底层的gc 过程"清除,而是需要C#端主动去release

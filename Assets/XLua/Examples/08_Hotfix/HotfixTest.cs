    ...
    public class HotfixTest : MonoBehaviour
    {
        ...
        void Update()
        {
            if (++tick % 50 == 0)
            {
                ...
                XzxTestChongZai1(tick, tick);
                XzxTestChongZai1(tick, tick, tick);
            }
        }

        void Test23432Fdsf324nc1(int b, int c, double d)
        {
        }

        void Testff2efewe3423f(int a, int b)
        {

        }

        private void XzxTestChongZai1(int a, int b)
        {
            Debug.Log("XzxTestChongZai1: int2 " + tick);
        }

        private void XzxTestChongZai1(int a, int b , int c)
        {
            Debug.Log("XzxTestChongZai1: int3 " + tick);
        }
        ...
        void OnGUI()
        {
            ...
            {
                /*luaenv.DoString(@"
                xlua.hotfixT(CS.XLuaTest.HotfixTest, 'XzxTestChongZai1', function(self,a,b)
                    
                        print('<<<<<<<<XzxTestChongZai1 in lua, int2 '..b)
                    
                end, 0)
                ");

                luaenv.DoString(@"
                xlua.hotfixT(CS.XLuaTest.HotfixTest, 'XzxTestChongZai1', function(self,a,b,c)
                    
                        print('<<<<<<<<XzxTestChongZai1 in lua, int3 '..b)
